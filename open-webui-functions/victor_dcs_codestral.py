"""
title: Victor DCS - Codestral
author: VictorRomeoSierra
version: 1.0.0
license: MIT
description: Victor DCS Assistant using Codestral model
...
class Pipe:
    ...
    def __init__(self):
        self.type = "pipe"
        self.id = "victor_codestral"
        self.name = "Victor DCS - Codestral"
        self.valves = self.Valves()
        
        # Model configuration
        self.ollama_model = "codestral:latest"
    ...
    def pipe(self, body: dict) -> str:
        """Routes requests through N8N webhook for DCS-enhanced responses using Codestral."""
        ...
        try:
            ...
            if self.valves.debug:
                print(f"[Victor-Codestral] Processing: {user_message[:50]}...")
                print(f"[Victor-Codestral] Timeout: {self.valves.timeout}s, Model: {self.ollama_model}")
            ...
            if self.valves.debug:
                print(f"[Victor-Codestral] Sending request to N8N...")
            ...
            if self.valves.debug:
                print(f"[Victor-Codestral] Received response: {response.status_code}")
