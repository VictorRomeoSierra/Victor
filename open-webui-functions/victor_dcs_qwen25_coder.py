"""
title: Victor DCS - Qwen2.5 Coder
author: VictorRomeoSierra
version: 1.0.0
license: MIT
description: Victor DCS Assistant using Qwen2.5 Coder model
...
class Pipe:
    ...
    def __init__(self):
        self.type = "pipe"
        self.id = "victor_qwen25_coder"
        self.name = "Victor DCS - Qwen2.5 Coder"
    ...
    def pipe(self, body: dict) -> str:
        """Routes requests through N8N webhook for DCS-enhanced responses using Qwen2.5 Coder."""
        ...
        try:
            ...
            if self.valves.debug:
                print(f"[Victor-Qwen2.5 Coder] Processing: {user_message[:50]}...")
                print(f"[Victor-Qwen2.5 Coder] Timeout: {self.valves.timeout}s, Model: {self.ollama_model}")
            ...
            if self.valves.debug:
                print(f"[Victor-Qwen2.5 Coder] Sending request to N8N...")
            ...
            if self.valves.debug:
                print(f"[Victor-Qwen2.5 Coder] Received response: {response.status_code}")
