"""
title: Victor DCS - Mistral
author: VictorRomeoSierra
version: 1.0.0
license: MIT
description: Victor DCS Assistant using Mistral model
...
class Pipe:
    ...
    def __init__(self):
        self.type = "pipe"
        self.id = "victor_mistral"
        self.name = "Victor DCS - Mistral"
    ...
    def pipe(self, body: dict) -> str:
        """Routes requests through N8N webhook for DCS-enhanced responses using Mistral."""
        ...
        try:
            ...
            if self.valves.debug:
                print(f"[Victor-Mistral] Processing: {user_message[:50]}...")
                print(f"[Victor-Mistral] Timeout: {self.valves.timeout}s, Model: {self.ollama_model}")
            ...
            if self.valves.debug:
                print(f"[Victor-Mistral] Sending request to N8N...")
            ...
            if self.valves.debug:
                print(f"[Victor-Mistral] Received response: {response.status_code}")
