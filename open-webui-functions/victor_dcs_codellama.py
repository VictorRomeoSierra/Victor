"""
title: Victor DCS - CodeLlama
author: VictorRomeoSierra
version: 1.0.0
license: MIT
description: Victor DCS Assistant using CodeLlama model
...
class Pipe:
    ...
    def __init__(self):
        self.type = "pipe"
        self.id = "victor_codellama"
        self.name = "Victor DCS - CodeLlama"
        self.valves = self.Valves()
        
        # Model configuration
        self.ollama_model = "codellama:latest"
    ...
    def pipe(self, body: dict) -> str:
        """Routes requests through N8N webhook for DCS-enhanced responses using CodeLlama."""
        ...
        try:
            ...
            if self.valves.debug:
                print(f"[Victor-CodeLlama] Processing: {user_message[:50]}...")
                print(f"[Victor-CodeLlama] Timeout: {self.valves.timeout}s, Model: {self.ollama_model}")
            ...
            if self.valves.debug:
                print(f"[Victor-CodeLlama] Sending request to N8N...")
            ...
            if self.valves.debug:
                print(f"[Victor-CodeLlama] Received response: {response.status_code}")
