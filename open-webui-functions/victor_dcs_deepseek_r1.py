"""
title: Victor DCS - DeepSeek R1
author: VictorRomeoSierra
version: 1.0.0
license: MIT
description: Victor DCS Assistant using DeepSeek R1 model
...
class Pipe:
    ...
    def __init__(self):
        self.type = "pipe"
        self.id = "victor_deepseek_r1"
        self.name = "Victor DCS - DeepSeek R1"
    ...
    def pipe(self, body: dict) -> str:
        """Routes requests through N8N webhook for DCS-enhanced responses using DeepSeek R1."""
        ...
        try:
            ...
            if self.valves.debug:
                print(f"[Victor-DeepSeek R1] Processing: {user_message[:50]}...")
                print(f"[Victor-DeepSeek R1] Timeout: {self.valves.timeout}s, Model: {self.ollama_model}")
            ...
            if self.valves.debug:
                print(f"[Victor-DeepSeek R1] Sending request to N8N...")
            ...
            if self.valves.debug:
                print(f"[Victor-DeepSeek R1] Received response: {response.status_code}")
